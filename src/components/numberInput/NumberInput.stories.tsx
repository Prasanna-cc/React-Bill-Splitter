...
// import { NumInputPropsGenerator } from "./numInputPropsGenerator";
...
export const DefaultBill: StoryFn<TemplateProps> = NumInputTemplate.bind({});
DefaultBill.args = {
  label: "Bill",
  typeOfIcon: "dollar",
};
...
export const DefaultNoOfPeople: StoryFn<TemplateProps> = NumInputTemplate.bind(
  {}
);
DefaultNoOfPeople.args = {
  label: "Number of people",
  typeOfIcon: "people",
};

export const NoOfPeopleFive: StoryFn<TemplateProps> = NumInputTemplate.bind({});
NoOfPeopleFive.args = {
  value: 5,
  label: "Number of people",
  typeOfIcon: "people",
...
export const NoOfPeopleError: StoryFn<TemplateProps> = NumInputTemplate.bind(
  {}
);
NoOfPeopleError.args = {
  value: -1,
  label: "Number of people",
  typeOfIcon: "people",
